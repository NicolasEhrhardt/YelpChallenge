...
numFiles = numel(dir(corpusFileName)) - 2; % number of files in corpusFileName
disp(['Number of files in corpus ' num2str(numFiles)])
...
for filei = 1:numFiles
    ...
    for batchj = 1:numBatches
        ...
        if (params.iter - params.lastSaved >= saveEvery || ...
            ...
            save(['../savedParams/wordreps_orig_' savedParam '.mat'], 'We');
        end
    end
end
end

...
class LinearRegressionLayer(object):
    def __init__(self, rng, input, n_in, n_out, W=None, b=None,
        ...
        self.output = T.flatten(lin_output if activation is None
...
class MLP(object):
    ...
    def __init__(self, rng, input, n_in, n_hidden, n_out):
        ...
        # of the hidden layer
        self.linearRegressionLayer = LinearRegressionLayer(
            rng=rng,
        ...
        self.cost = self.linearRegressionLayer.cost
        # same holds for the function computing the number of errors
        self.empirical_cost = self.linearRegressionLayer.empirical_cost
...
def test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000,
   ...
   """
    ...
    regression = MLP(rng=rng, input=x, n_in=n_in,
                     n_hidden=n_hidden, n_out=n_out)

    # the cost we minimize during training is the negative log likelihood of
    # the model plus the regularization terms (L1 and L2); cost is expressed
    # here symbolically
    cost = regression.cost(y) \
    ...
    test_model = theano.function(inputs=[index],
            outputs=regression.empirical_cost(y),
            givens={
    ...
    patience = 3 * n_train_batches # look as this many examples regardless
...
if __name__ == '__main__':
    test_mlp(dataset='data.pkl.gz', n_in=50, n_out=1, n_hidden=200)

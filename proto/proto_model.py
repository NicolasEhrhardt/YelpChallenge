...
X_valid = X_train_all[permut[0:validsz], :]
Y_valid = Y_train_all[permut[0:validsz]]
print("- valid set of size: %d" % len(Y_valid))

X_train = X_train_all[permut[validsz::], :]
Y_train = Y_train_all[permut[validsz::]]
print("- train set of size: %d" % len(Y_train))
